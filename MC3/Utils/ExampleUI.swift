    ...
    var body: some View {
        VStack{
            ...
            Button(action: {
                ...
                let module = ModuleModel(name: "Lorem", author: self.dataCenter.getActiveUser()!, coverImageName: URL(fileURLWithPath: "people"), addDate: Date.init(), level: .easy, genre: .horror, content: moduleContent)
